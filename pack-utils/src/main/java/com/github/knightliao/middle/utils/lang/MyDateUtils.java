...
public final class MyDateUtils {
    ...
    public static Date parseDate(String date) {
        ...
        try {
            return DateUtils.parseDate(date, new String[] {DSP_DEFAULT_TIME_FORMAT});
        } catch (ParseException e) {
            return null;
        }
    }
    ...
    public static Date getFirstDayOfMonth(Date date) {
        ...
        return DateUtils.setDays(date, firstDay);
    }
    ...
    public static String parseFullFormat(String dateStr, String pattern, int addDays) {
        try {
            ...
            return MyDateUtils.format(date, "yyyy-MM-dd HH:mm:ss");
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public static boolean isOverlay(String date1StartStr, String date1EndStr, String date2StartStr, String date2EndStr,
                                    String patten) {
        Date date1Start = MyDateUtils.parseDate(date1StartStr, patten);
        Date date1End = MyDateUtils.parseDate(date1EndStr, patten);
        Date date2Start = MyDateUtils.parseDate(date2StartStr, patten);
        Date date2End = MyDateUtils.parseDate(date2EndStr, patten);
